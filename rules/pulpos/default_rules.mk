...
ifeq ($(bootmode), axi_preload)
vsim_flags += -gLOAD_L2=PRELOADED
else
$(error Illegal value supplied for bootmode. Legal values are 'spi', 'hyperflash', 'fast_debug', 'axi_preload' and 'jtag')
endif
endif
endif
endif
