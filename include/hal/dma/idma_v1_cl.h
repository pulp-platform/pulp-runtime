...
#ifndef __HAL_CL_IDMA_V1_H__
#define __HAL_CL_IDMA_V1_H__
 ...
 *
  ...
  */
static inline int plp_cl_dma_memcpy(dma_ext_t ext, unsigned int loc, unsigned int size, int ext2loc);
